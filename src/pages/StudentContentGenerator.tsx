...
const StudentContentGenerator = () => {
  ...
  const generateQuestions = async () => {
    ...
    try {
      // Create FormData with ONLY the file (matching your successful API test)
      const form = new FormData();
      form.append("file", questionFile);
      
      console.log("🚀 Sending ONLY file to exam_generate endpoint (matching your successful API test):");
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                      <p className="text-sm text-blue-800 dark:text-blue-200">
                        <strong>📄 PDF Files Only:</strong> Practice questions are currently supported for PDF files only. For other file types (PPT, PPTX, Word), please use the Summary or Key Points features.
                      </p>
                    </div>
                    <MaterialUploader 
                      onFileSelected={handleQuestionFileSelected}
                      allowedTypes={['.pdf']}
                      helpText="Supports PDF files only"
                    />
