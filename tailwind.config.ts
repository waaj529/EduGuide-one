	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				textContent: {
					DEFAULT: '#1A202C', // Dark text for light mode
					secondary: '#4A5568', // Secondary text for light mode
					muted: '#718096', // Muted text for light mode
					dark: '#F7FAFC',  // Light text for dark mode
					darkSecondary: '#E2E8F0', // Secondary text for dark mode
					darkMuted: '#A0AEC0', // Muted text for dark mode
				},
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				...
				'button-pulse': {
					...
					'50%': { boxShadow: '0 0 0 10px rgba(30, 136, 229, 0.3)' }
				},
				'text-shimmer': {
